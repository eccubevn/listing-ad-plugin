...
class ExportControllerTest extends AbstractAdminWebTestCase
{
    ...
    {
        $this->client->request('GET', $this->generateUrl('ListingAdCsv_export', ['type' => $type]));
    ...
    public function testExport_WithSearch($type, $expected)
    {
        ...
        $this->client->request('POST',
            ...
            ['admin_search_product' => $this->createSearchForm($Product)]
        );
        $this->client->request('GET',
            $this->generateUrl('ListingAdCsv_export', ['type' => $type]),
            [], [],
